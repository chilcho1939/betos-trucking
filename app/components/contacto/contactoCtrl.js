myApp.controller('contactoCtrl', ['$scope', '$compile', function($scope, $compile) {
    ...
    function buildMap(lat, lon) {
        ...
        //adding popup text
        markerZamora.bindPopup('<div class="row"><div class="col-xs-12 text-center widget recent-gallery"><figure class="image"><a class="lightbox-image"><IMG BORDER="0" ALIGN="center" src="resources/images/resource/author-thumb-2.jpg"></a></figure></div><div class="col-xs-12 text-center">' + markerZamoraData + '</div></div>').openPopup();
        markerLaredo.bindPopup('<div class="row"><div class="col-xs-12 text-center widget recent-gallery"><figure class="image"><a class="lightbox-image"><IMG BORDER="0" ALIGN="center" src="resources/images/resource/author-thumb-2.jpg"></a></figure></div><div class="col-xs-12 text-center">' + markerLaredoData + '</div></div>').openPopup();
        markerUruapan.bindPopup('<div class="row"><div class="col-xs-12 text-center widget recent-gallery"><figure class="image"><a class="lightbox-image"><IMG BORDER="0" ALIGN="center" src="resources/images/resource/author-thumb-2.jpg"></a></figure></div><div class="col-xs-12 text-center">' + markerUruapanData + '</div></div>').openPopup();
        markerReynosa.bindPopup('<div class="row"><div class="col-xs-12 text-center widget recent-gallery"><figure class="image"><a class="lightbox-image"><IMG BORDER="0" ALIGN="center" src="resources/images/resource/author-thumb-2.jpg"></a></figure></div><div class="col-xs-12 text-center">' + markerReynosaData + '</div></div>').openPopup();
    }
